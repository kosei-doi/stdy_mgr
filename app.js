...
// 科目ごとの背景色を定義（より薄い色で見やすく）
const subjectColors = {
  'CS': '#FEF7F7', // コンピュータサイエンス - より薄いピンク
  '微分積分': '#F7FEF7', // 数学 - より薄いグリーン
  'Cプロ': '#F7FBFF', // プログラミング - より薄いブルー
  '実験': '#FFFEF7', // 実験 - より薄いイエロー
  '線形代数': '#FFF7F0', // 数学 - より薄いオレンジ
  '中国語IA': '#FBF7FF', // 語学 - より薄いパープル
  '中国語IB': '#FEF7FB', // 語学 - より薄いマゼンタ
  '憲法IB': '#F7FEFB', // 法学 - より薄いティール
  '電磁気学A': '#FEF7F7', // 物理学 - より薄いレッド
  '電生': '#F7FEF7', // 電気・生物 - より薄いライム
  '生命科学A': '#F7FBFF', // 生物学 - より薄いスカイブルー
  '力学A': '#FFFBF7', // 物理学 - より薄いゴールド
  'ALC': '#FBF7FF', // 語学 - より薄いバイオレット
  '化学': '#F7FEFB', // 化学 - より薄いアクア
  '科学と芸術': '#FEF7FF', // 科学と芸術 - より薄いフクシア
  '身体論': '#F7F7FF', // 身体論 - より薄いインディゴ
  '電基礎': '#FEF7F7', // 電気基礎 - より薄いローズ
  '生命科学': '#FBFEF7'  // 生命科学 - より薄いライムグリーン
};
