...
// 科目ごとの背景色を定義（科目の特性に合わせて再設定）
const subjectColors = {
  'CS': '#E3F2FD', // コンピュータサイエンス - 爽やかな水色
  '微分積分': '#FFF3E0', // 数学 - 温かみのあるオレンジ
  'Cプロ': '#E8F5E8', // プログラミング - フレッシュなグリーン
  '実験': '#F3E5F5', // 実験 - 落ち着いたラベンダー
  '線形代数': '#E1F5FE', // 数学 - クリアなスカイブルー
  '中国語IA': '#FCE4EC', // 語学 - 優しいピンク
  '中国語IB': '#F8BBD9', // 語学 - 少し濃いピンク
  '憲法IB': '#EDE7F6', // 法学 - 上品なパープル
  '電磁気学A': '#FFF8E1', // 物理学 - 明るいイエロー
  '電生': '#E0F2F1', // 電気・生物 - 清涼なティール
  '生命科学A': '#E8F5E9', // 生物学 - 自然なグリーン
  '力学A': '#F1F8E9', // 物理学 - ミントグリーン
  'ALC': '#E8EAF6'  // 語学 - ライトブルー
};
