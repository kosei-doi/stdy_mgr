...
// 科目ごとの背景色を定義（鮮やかで区別しやすい色に変更）
const subjectColors = {
  'CS': '#FFE0E6', // コンピュータサイエンス - 明るいピンク
  '微分積分': '#E6F3FF', // 数学 - 鮮やかなブルー
  'Cプロ': '#E6FFE6', // プログラミング - 鮮やかなグリーン
  '実験': '#FFF0E6', // 実験 - 鮮やかなオレンジ
  '線形代数': '#F0E6FF', // 数学 - 鮮やかなパープル
  '中国語IA': '#FFE6F0', // 語学 - 鮮やかなピンク
  '中国語IB': '#E6F0FF', // 語学 - 鮮やかなライトブルー
  '憲法IB': '#F0FFE6', // 法学 - 鮮やかなライトグリーン
  '電磁気学A': '#FFFFE6', // 物理学 - 鮮やかなイエロー
  '電生': '#E6FFFF', // 電気・生物 - 鮮やかなシアン
  '生命科学A': '#F0E6FF', // 生物学 - 鮮やかなライトパープル
  '力学A': '#E6FFE6', // 物理学 - 鮮やかなミントグリーン
  'ALC': '#FFE6FF', // 語学 - 鮮やかなライトピンク
  '化学': '#E6FFE6', // 化学 - 鮮やかなグリーン
  '科学と芸術': '#FFE6FF', // 科学と芸術 - 鮮やかなライトピンク
  '身体論': '#F0FFE6', // 身体論 - 鮮やかなライトグリーン
  '電基礎': '#E6F0FF', // 電気基礎 - 鮮やかなライトブルー
  '生命科学': '#F0E6FF'  // 生命科学 - 鮮やかなライトパープル
};
