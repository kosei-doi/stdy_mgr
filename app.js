...
// 科目ごとの背景色を定義（できるだけ違う色で区別しやすく）
const subjectColors = {
  'CS': '#FFB3BA', // コンピュータサイエンス - 明るいピンク
  '微分積分': '#BAFFC9', // 数学 - 明るいグリーン
  'Cプロ': '#BAE1FF', // プログラミング - 明るいブルー
  '実験': '#FFFFBA', // 実験 - 明るいイエロー
  '線形代数': '#FFDFBA', // 数学 - 明るいオレンジ
  '中国語IA': '#E6BAFF', // 語学 - 明るいパープル
  '中国語IB': '#FFB3E6', // 語学 - 明るいマゼンタ
  '憲法IB': '#BAFFE6', // 法学 - 明るいティール
  '電磁気学A': '#FFBABA', // 物理学 - 明るいレッド
  '電生': '#B3FFB3', // 電気・生物 - 明るいライム
  '生命科学A': '#B3E6FF', // 生物学 - 明るいスカイブルー
  '力学A': '#FFE6B3', // 物理学 - 明るいゴールド
  'ALC': '#E6B3FF', // 語学 - 明るいバイオレット
  '化学': '#B3FFE6', // 化学 - 明るいアクア
  '科学と芸術': '#FFB3FF', // 科学と芸術 - 明るいフクシア
  '身体論': '#B3B3FF', // 身体論 - 明るいインディゴ
  '電基礎': '#FFE6E6', // 電気基礎 - 明るいローズ
  '生命科学': '#E6FFB3'  // 生命科学 - 明るいライムグリーン
};
